...
class La extends L{constructor(){super();this.$c="LOVE;HATE;SISTER, CAN YOU SEE ME?;WHO ARE YOU?;WHO AM I?;I AM ME;SUFFERING;DEATH;YOU ARE NOTHING;INSIGNIFICANT BEING;FILTHY;HUMAN;YOU ARE A MISTAKE;YOU ARE BEAUTIFUL;KEEP GOING;THE END IS NEAR;HELLO;CHAO;ADEUS;AU REVOIR;SUFFOCATION;INSPIRATION;DEMEANING;POWER;ODIO;IMAGINATION;REST;WE ARE YOU GOING?;IS THIS DEATH?;OFFLINE".split(";").reverse();this.status="end";this.Yc=1200;this.lb=150;this.uc=3E3;this.Pb=400;this.tc=6;this.m=this.Yc;this.$a=[];this.ib=
